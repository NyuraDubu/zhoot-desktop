...
<section id="avis" class="w-full py-24 sm:py-28 bg-white reveal" data-reveal-fade>
    <div class="max-w-6xl mx-auto px-4 sm:px-6 md:px-8">
        <div class="max-w-3xl mx-auto text-center reveal" style="--reveal-delay:40ms">
            <h2 class="font-europa font-bold text-[#354762] text-2xl sm:text-3xl md:text-5xl leading-tight tracking-tight flex items-center justify-center gap-3">
        ...
        <!-- Testimonials -->
    <div class="mt-14 sm:mt-16 grid gap-6 sm:gap-8 md:grid-cols-3 reveal-stagger-parent" data-testimonials>
            @foreach($testimonials as $t)
                <figure class="testimonial reveal bg-white rounded-2xl p-6 shadow-sm border border-[#E6E8EC] flex flex-col relative overflow-hidden" style="--reveal-delay: {{ 120 + $loop->index * 90 }}ms">
                    ...
                    <blockquote class="text-[14px] sm:text-[15px] text-[#354762] leading-relaxed font-medium font-europa">
                        “{{ $t['quote'] }}”
                    </blockquote>
                    <figcaption class="mt-4 sm:mt-5 text-[12px] sm:text-[13px] text-[#6F757C] font-europa">
        ...
        <!-- Logos -->
    <div class="mt-16 sm:mt-20 flex flex-wrap justify-center items-center gap-x-8 sm:gap-x-10 gap-y-6 sm:gap-y-8 opacity-90 reveal-stagger-parent" data-logos>
