    ...
    <div class="mx-auto max-w-7xl px-6 pt-16 pb-10">
        <div class="grid gap-12 md:gap-16 lg:grid-cols-12">
            ...
            <div class="lg:col-span-4 space-y-6">
                ...
                <div class="space-y-3">
                    <form action="#newsletter" method="post" class="flex gap-2" onsubmit="event.preventDefault(); /* hook */">
                        ...
                        <button class="rounded-md bg-[#BB3381] text-white text-sm font-semibold px-4 py-2 hover:opacity-90 transition">S'inscrire</button>
                    </form>
                    <p class="text-[11px] text-slate-500">En vous inscrivant, vous acceptez notre <a href="#" class="underline decoration-slate-600 hover:text-slate-300">politique de confidentialité</a>.</p>
                </div>
            </div>

            <!-- Navigation Groups -->
            <div class="lg:col-span-8 grid gap-10 sm:grid-cols-3">
                <div>
                    <h3 class="text-sm font-semibold tracking-wide text-white mb-4">Produit</h3>
                ...
                <div>
                    <h3 class="text-sm font-semibold tracking-wide text-white mb-4">Ressources</h3>
                    <ul class="space-y-2 text-sm">
                ...
                <div>
                    <h3 class="text-sm font-semibold tracking-wide text-white mb-4">Légal</h3>
                    <ul class="space-y-2 text-sm">
        ...
        <div class="mt-16 pt-8 border-t border-slate-800 flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
            <p class="text-xs text-slate-500">&copy; {{ date('Y') }} Zhoot. Tous droits réservés. Développé par <span class="text-slate-400">quelqu'un</span>.</p>
