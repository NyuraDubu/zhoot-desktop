...
<section class="relative overflow-hidden reveal" data-reveal-fade>
    ...
    <div class="flex justify-center mb-6 reveal" style="--reveal-delay:40ms">
        ...
        <!-- Title -->
    <h1 class="text-center font-bold leading-tight tracking-tight text-[#354762] font-europa reveal" style="font-size:56px; --reveal-delay:80ms">
    ...
    <p class="mt-5 text-center text-[#87898D] font-europa font-medium reveal" style="font-size:22px; --reveal-delay:120ms">
    ...
    <div class="mt-8 flex flex-col items-center gap-3 reveal" style="--reveal-delay:160ms">
            <a href="#signup" class="inline-flex items-center rounded-full px-8 py-3 font-bold text-white bg-[#BB3381] shadow hover:opacity-90 focus-visible:outline focus-visible:outline-offset-2 focus-visible:outline-fuchsia-500 transition" style="font-size:17px;">Commencer à créer gratuitement</a>
            <p class="text-[13px] text-[#6F757C] font-medium"><span class="text-[#6F757C] font-extrabold">3 crédits offerts</span> - Aucune carte de crédit requise</p>
        </div>
